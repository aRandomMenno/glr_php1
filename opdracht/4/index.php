    ...
    <fieldset>
        ...
        <form action="index_process.php" method="post">
            <p>
                ...
                <input type="text" name="voornaam" id="voornaam" placeholder="Jan" minlength="2" maxlength="31" required>
                <span <?php if (!isset($errors['voornaam'])) { ?> class="hidden" <?php } ?> style="color: red;">
                    <?= $errors['voornaam'] ?>
                </span>
            <p>
                <label for="achternaam">Uw achternaam:</label>
                <input type="text" name="achternaam" id="achternaam" minlength="2" maxlength="31" placeholder="Doorn" required>
            ...
            <p>
                ...
                <input type="email" name="email" id="email" placeholder="mail@domain.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" maxlength="63" required>
            ...
            <p>
                ...
                <input type="tel" name="telefoonNummer" id="telefoonNummer" placeholder="0612345678" pattern="^(06|01|07)[0-9]{8}$" title="Voer een geldig Nederlands telefoonnummer in (10 cijfers, beginnend met 06, 01 of 07)" required>
            ...
            <p>
                ...
                <input type="text" name="huisnummer" id="huisnummer" placeholder="123" pattern="[0-9]{1,5}" title="Voer een huisnummer in (alleen cijfers)" required>
                <span <?php if (!isset($errors['huisnummer'])) { ?> class="hidden" <?php } ?> styrequiredle="color: red;">
                    <?= $errors['huisnummer'] ?>
                </span>
            </p>
            <p>
                <label for="bsn">Uw BSN-nummer</label>
                <input type="text" name="bsn" id="bsn" placeholder="123456789" pattern="[0-9]{9}" minlength="9" maxlength="9" title="Een BSN bestaat uit 9 cijfers" required>
